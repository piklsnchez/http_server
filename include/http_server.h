...
struct http_server{
  ...
  int                         (*processRequest)(struct http_server* this, int fd);
  ...
  void                        (*doWebsocket)(struct http_server* this, struct socket* client, struct hash_map* headers);
...
void                        http_server_processRequest(struct http_server* this, int fd);
